...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const showTutorial = () => {
        ...
        const steps = [
            ...
            "📱 **На телефонах:**\nБоковая панель скрыта, но подсказка текущего слова всплывает над сеткой.\nВсе подсказки доступны в боковой панели на компьютере.",
            "🎯 **Очки:**\n+10 за каждое угаданное слово, +50 за полностью решённый кроссворд.\nЗа подсказку –20 очков, за покупку кроссворда – его цена.",
            "💰 **Магазин:**\nТратьте очки на скины (они украшают заблокированные ячейки), увеличение лимита подсказок и рулетку.",

...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const showTutorial = () => {
        ...
        const steps = [
            ...
            "🎨 Магазин и темы\nЗа очки покупайте скины на клетки, темы оформления («Тема») и улучшения",
            "Рулетка (бесплатно раз в день или за 20 очков) даёт шанс выиграть до 200 очков",
            "🎯 Прогресс и сброс\n• Кроссворд можно сбросить (кнопка «Сбросить»), вернув очки за слова и подсказки\n• Кнопка «Сбросить всё» удаляет весь прогресс: очки, скины, темы, достижения",
            "📋 Ежедневные задания\nВыполняйте – получайте бонусные очки. Задания обновляются каждый день",
            "🏆 Достижения – долгосрочные цели с наградами",
            "🌓 Приятной игры!"
        ];
        let step = 0;
